...
public class RandomLazerFactoryTest {
    ...
    void newLazerIsNotNull() {
        ...
        Lazer lazer = lazerFactory.newLazer(800, 600, 50);
        assertNotNull(lazer);
    }
    ...
    void newLazerHasYWithinMargin() {
        ...
        Lazer lazer = factory.newLazer(worldWidth, worldHeight, margin);
    ...
    void newLazerCorrectHeight() {
        ...
        Lazer lazer = factory.newLazer(800, worldHeight, 50);
    ...
    void newLazerCorrectWidth() {
        ...
        Lazer lazer = factory.newLazer(worldWidth, 600, 50);
