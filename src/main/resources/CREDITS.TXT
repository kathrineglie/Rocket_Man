...
URL:
    https://opengameart.org/content/some-animal-noise
...
File(s):
    * some animal noise.wav

----------------------------------------

Title:
    Jay The Doggo - Sound Effects

Author:
    Spring Spring

URL:
    https://opengameart.org/content/jay-the-doggo-sound-effects
...
File(s):
    ...
    * sfx-footstep.wav
    * sfx-trip.wav
    * sfx-death jingle.wav
    * sfx-alarm.wav
    * sfx-collect a nice big strawberry.wav
    * sfx-gift wrapping opens.wav
    * sfx-collect wpn.wav
    * sfx-throw.wav
    * sfx-block.wav
    * sfx-enemyhit.wav
...
Copyright/Attribution Notice:
    Credit to isaiah658 is not required, but is appreciated.

File(s):
    * Reverse-Time-Loop-isaiah658.ogg
    * Reverse-Time-Loop-isaiah658.wav
...
URL:
    https://opengameart.org/content/witch-cackle
...
File(s):
    * movingshield_sound.ogg

----------------------------------------

Title:
    Ambient Alien Light sfx

Author:
    Dr. Neptune

URL:
    https://opengameart.org/content/ambient-alien-light-sfx
...
File(s):
    * SFX- The Ultimate 2017 16 bit Mini pack.zip
...
URL:
    https://opengameart.org/content/sfx-the-ultimate-2017-8-bit-mini-pack
...
File(s):
    * SFX- The Ultimate 2017 8 bit Mini pack.zip
...
URL:
    https://opengameart.org/content/bell-arpeggio-24

License(s):
    * CC0 ( http://creativecommons.org/publicdomain/zero/1.0/legalcode )

Copyright/Attribution Notice:
    OPTIONAL ATTRIBUTION: The Cynic Project / cynicmusic.com / pixelsphere.org
...
Title:
    Various sound effects pack 1

Author:
    phoenix1291

URL:
    https://opengameart.org/content/various-sound-effects-pack-1
...
File(s):
    * Various sound effects - Free mini pack.zip

----------------------------------------

Title:
    Sound effects Mini Pack1.5
...
File(s):
    * Sound effects Mini Pack1.5.zip
...
URL:
    https://opengameart.org/content/fast-hammer-sfx
...
Title:
    Voiceover Pack: Fighter (40+ taunts)
...
File(s):
    * kenney_voiceoverFighter.zip

----------------------------------------

Title:
    58 Random Sound Effects

Author:
    TokyoGeisha

URL:
    https://opengameart.org/content/58-random-sound-effects
...
Copyright/Attribution Notice:
    Use however you want, even commercially. No credit needed
...
Title:
    50 Free SciFi SoundFX - 192kHz, 64-bit 24,576kbps WAV
...
File(s):
    * 50-Free-SciFi-SFX-blacklodgegames.com_.zip
...
URL:
    https://opengameart.org/content/camera
...
Copyright/Attribution Notice:
    I waive all of my rights to these sound files.
...
Title:
    Superpowers assets sound effects
...
File(s):
    * superpowers-asset-packs-soundeffects.zip

----------------------------------------

Title:
    Hurt / Death sound effect for character
...
File(s):
    * 8-bit Sound Effects Pack 001.zip
    * DEMO.mp3
...
Title:
    Little Girl saying Game Over

Author:
    freestockimages

URL:
    https://opengameart.org/content/little-girl-saying-game-over
...
Copyright/Attribution Notice:
    Attribution is not necessary but is appreciated when possible :)
...
Title:
    Fantasy Weapons and Apparel SFX Library
...
File(s):
    * 105016__julien-matthey__jm-fx-fireball-01.wav
...
Copyright/Attribution Notice:
    This pack is released under the public domain CC0 license.
If you want to give credit (not required): "WobbleBoxx Workshop"
...
Copyright/Attribution Notice:
    You don&#039;t need to attribute me.
Feel free to check out my site with more free resources (e.g. generators and gameart experiments): http://tinyworlds.org/
...
URL:
    https://opengameart.org/content/zombie-pain
...
Title:
    Wooden dice on wodden table roll

Author:
    Wuzzy

URL:
    https://opengameart.org/content/wooden-dice-on-wodden-table-roll

License(s):
    * CC0 ( http://creativecommons.org/publicdomain/zero/1.0/legalcode )

File(s):
    * Holzwürfel_auf_Holztisch_1.flac
    * Holzwürfel_auf_Holztisch_2.flac
    * Holzwürfel_auf_Holztisch_3.flac
    * Holzwürfel_auf_Holztisch_4.flac
...
SPECIAL ATTRIBUTION INSTRUCTIONS:
    These sounds were created and recorded by Ben Jaszczak, Brian Nelson, Kevin Heras, and Matthew Nanney

File(s):
    * Prepared SFX Library.7z
...
Copyright/Attribution Notice:
    If you want to, you can credit me with my real name: Simon Lübeß
...
URL:
    https://opengameart.org/content/get-ruby-se
...
URL:
    https://opengameart.org/content/zipper
...
Title:
    Sound Effects from Monster RPG 2

Author:
    troutsneeze

URL:
    https://opengameart.org/content/sound-effects-from-monster-rpg-2

License(s):
    * CC0 ( http://creativecommons.org/publicdomain/zero/1.0/legalcode )

File(s):
    * Monster RPG 2 Sound Effects - OGG - revised.tar.gz
    * Monster RPG 2 Sound Effects - OGG.zip

----------------------------------------

Title:
    Earth Element Magic Spell
...
File(s):
    * Earth Element Magic Spell.flac
    * Earth Element Magic Spell.ogg
...
URL:
    https://opengameart.org/content/steam-whistle
...
URL:
    https://opengameart.org/content/freeze-spell-0
...
File(s):
    * monster_sfx_pack_2.zip

----------------------------------------

Title:
    Silent beast growls(4)
...
File(s):
    * silent_beast_growl.mp3
    * silent_beast_growl_1.mp3
    * silent_beast_growl_2.mp3
    * silent_beast_growl_3.mp3

----------------------------------------

Title:
    Small pest alien/creature

Author:
    Brandon Morris

URL:
    https://opengameart.org/content/small-pest-aliencreature
...
URL:
    https://opengameart.org/content/dog-grunt

License(s):
    * CC0 ( http://creativecommons.org/publicdomain/zero/1.0/legalcode )

File(s):
    * dog-frieda-grunt-96khz-01.flac
...
URL:
    https://opengameart.org/content/peacock-scream
...
URL:
    https://opengameart.org/content/evil-creature
...
Title:
    Wood and Metal Sound Effects: Volume 2
...
URL:
    https://opengameart.org/content/growl
...
File(s):
    * independent_nu_ljudbank-hits_and_punches.7z
...
File(s):
    * Owlish Media Sound Effects.zip
...
URL:
    https://opengameart.org/content/missile-sound

License(s):
    * CC0 ( http://creativecommons.org/publicdomain/zero/1.0/legalcode )

Copyright/Attribution Notice:
    free for use in your project, don&#039;t worry about license.
...
URL:
    https://opengameart.org/content/car-acceleration
